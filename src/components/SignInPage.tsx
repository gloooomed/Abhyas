      ...
      <main className="flex-1 flex items-center justify-center pt-28 pb-16 px-4">
        <div className="w-full max-w-[420px]">
          ...
          >
            ...
            <p className="text-slate-500 dark:text-zinc-400 tracking-tight text-sm">Sign in to continue to Abhyas.</p>
          </motion.div>
          ...
          >
            <div className="sutera-card p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-sm font-medium tracking-tight text-slate-700 dark:text-zinc-300">
                      Password
                    </label>
                    <Link
                      to="/sign-in/forgot-password"
                      className="text-xs text-slate-500 dark:text-zinc-500 hover:text-black dark:hover:text-white transition-colors tracking-tight"
                    >
                      Forgot password?
                    </Link>
                  </div>
              ...
              <p className="text-center text-sm text-slate-500 dark:text-zinc-500 tracking-tight mt-6">
                ...
                <Link to="/sign-up" className="text-black dark:text-white font-medium hover:underline underline-offset-2 transition-all">
                  Sign up
                </Link>
              </p>
            </div>
